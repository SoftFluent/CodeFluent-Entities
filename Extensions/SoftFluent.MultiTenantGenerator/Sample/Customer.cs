...
namespace Sample
{
    ...
    public partial class Customer : System.ICloneable, System.IComparable, System.IComparable<Sample.Customer>, CodeFluent.Runtime.ICodeFluentCollectionEntity<System.Guid>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<Sample.Customer>
    {
        ...
        public virtual bool Equals(Sample.Customer customer)
        {
            if ((customer == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			customer = obj as Sample.Customer;
...
customer = value as Sample.Customer;
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = Sample.Resources.Manager.GetStringWithDefault(culture, "Sample.Customer.ExternalValidate", "Type \'Sample.Customer\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = Sample.Resources.Manager.GetStringWithDefault(culture, "Sample.Customer.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "ample.Customer\'", null);
        ...
        public virtual bool Delete()
        {
            ...
            persistence.CreateStoredProcedureCommand("SoftFluent", "Customer", "Delete");
        ...
        public static Sample.Customer Load(System.Guid id)
        {
            ...
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(Sample.Constants.SampleStoreName).Persistence;
            persistence.CreateStoredProcedureCommand("SoftFluent", "Customer", "Load");
        ...
        public static Sample.Customer LoadById(System.Guid id)
        {
            if ((id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                return null;
            ...
            Sample.Customer customer = new Sample.Customer();
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(Sample.Constants.SampleStoreName).Persistence;
            persistence.CreateStoredProcedureCommand("SoftFluent", "Customer", "LoadById");
            persistence.AddParameter("@Id", id, CodeFluentPersistence.DefaultGuidValue);
            System.Data.IDataReader reader = null;
            try
            {
        ...
        protected virtual bool BaseSave(bool force)
        {
            ...
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(Sample.Constants.SampleStoreName).Persistence;
            persistence.CreateStoredProcedureCommand("SoftFluent", "Customer", "Save");
            persistence.AddParameter("@Customer_Id", this.Id, CodeFluentPersistence.DefaultGuidValue);
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static Sample.Customer LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            customer = Sample.Customer.Load(var);
            return customer;
        }
