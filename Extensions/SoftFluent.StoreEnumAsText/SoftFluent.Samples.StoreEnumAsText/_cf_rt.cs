...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0772", "CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 07 July " +
    "2014 17:45.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 3442969604u)]

namespace SoftFluent.Samples.StoreEnumAsText.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.StoreEnumAsText.SoftFluent.Samples.StoreEnumAsText", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.StoreEnumAsText.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.StoreEnumAsText.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.StoreEnumAsText.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.StoreEnumAsText.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.StoreEnumAsText.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.StoreEnumAsText
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_StoreEnumAsTextStoreName = "SoftFluent.Samples.StoreEnumAsText";
