...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0786", "CodeFluent Entities generated (http://www.softfluent.com). Date: Sunday, 16 Novem" +
    "ber 2014 12:44.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 1116980179u)]

namespace SoftFluent.Samples.RedisCache.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.RedisCache.SoftFluent.Samples.RedisCache", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.RedisCache.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.RedisCache.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.RedisCache.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.RedisCache.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.RedisCache.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.RedisCache
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_RedisCacheStoreName = "SoftFluent.Samples.RedisCache";
...
namespace SoftFluent.Samples.RedisCache.Caching
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0786")]
    public sealed partial class CacheManager0
    {
        
        static SoftFluent.Samples.RedisCache.Caching.LocaleRedisCacheManager _manager;
        
        static CacheManager0()
        {
            CacheManager0._manager = new SoftFluent.Samples.RedisCache.Caching.LocaleRedisCacheManager();
        }
        
        private CacheManager0()
        {
        }
        
        public static CodeFluent.Runtime.Caching.ICacheManager Manager
        {
            get
            {
                return CacheManager0._manager;
            }
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0786")]
    public sealed partial class CacheManager1
    {
        
        static SoftFluent.Samples.RedisCache.Caching.RedisCacheManager _manager;
        
        static CacheManager1()
        {
            CacheManager1._manager = new SoftFluent.Samples.RedisCache.Caching.RedisCacheManager();
        }
