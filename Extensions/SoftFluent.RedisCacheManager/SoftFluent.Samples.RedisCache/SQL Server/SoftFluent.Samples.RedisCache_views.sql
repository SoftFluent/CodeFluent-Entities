...
AS
SELECT [Product].[Product_Id], [Product].[Product_Name], [Product].[Product_Category_Id], [Product].[_rowVersion], [Product].[_trackCreationTime], [Product].[_trackLastWriteTime], [Product].[_trackCreationUser], [Product].[_trackLastWriteUser] 
    FROM [Product]
GO
