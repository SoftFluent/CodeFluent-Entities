...
namespace SoftFluent.Samples.RedisCache
{
    ...
    public partial class Category : System.ICloneable, System.IComparable, System.IComparable<SoftFluent.Samples.RedisCache.Category>, CodeFluent.Runtime.ICodeFluentCollectionEntity<System.Guid>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<SoftFluent.Samples.RedisCache.Category>
    {
        ...
        private SoftFluent.Samples.RedisCache.ProductCollection _products;
        
        // Snippet method 'SaveLocalizedValuesThunk'
private static void SaveLocalizedValuesUpdateRowVersion(System.Data.IDataReader reader, SoftFluent.Samples.RedisCache.Category entity, int lcid, bool isDefault, params object[] localizedValues){if (!reader.Read()) return; byte[] rowVersion = CodeFluent.Runtime.CodeFluentPersistence.GetReaderValue(reader, "_rowVersion", (byte[])null); if (rowVersion != null) {entity.RowVersion = rowVersion;}}protected virtual void SaveLocalizedValues(){SaveLocalizedValues(this, System.Threading.Thread.CurrentThread.CurrentUICulture.LCID, false, this.Name);}
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public SoftFluent.Samples.RedisCache.ProductCollection Products
        {
            get
            {
                if ((this._products == null))
                {
                    ...
                    {
                        this._products = new SoftFluent.Samples.RedisCache.ProductCollection(this);
                        return this._products;
                    }
                    this._products = SoftFluent.Samples.RedisCache.ProductCollection.LoadByCategory(this);
                }
                return this._products;
            }
        }
        ...
        public virtual bool Equals(SoftFluent.Samples.RedisCache.Category category)
        {
            if ((category == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			category = obj as SoftFluent.Samples.RedisCache.Category;
...
category = value as SoftFluent.Samples.RedisCache.Category;
        ...
        public virtual int CompareTo(SoftFluent.Samples.RedisCache.Category category)
        {
            if ((category == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = SoftFluent.Samples.RedisCache.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.RedisCache.Category.ExternalValidate", "Type \'SoftFluent.Samples.RedisCache.Category\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = SoftFluent.Samples.RedisCache.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.RedisCache.Category.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "oftFluent.Samples.RedisCache.Category\'", null);
        ...
        {
            SoftFluent.Samples.RedisCache.Category.ClearCache();
            bool ret = false;
        ...
        private static SoftFluent.Samples.RedisCache.Category CacheLoad(bool useCache, System.Guid id)
        {
            ...
            if ((useCache == true))
            {
                cacheKey = CodeFluent.Runtime.Caching.SimpleCacheManager.BuildCacheKey("d12f6f7a8f113d967a2e31881b188e9a", id);
...
category = SoftFluent.Samples.RedisCache.Caching.CacheManager0.Manager.Get("SoftFluent.Samples.RedisCache.Category", cacheKey) as SoftFluent.Samples.RedisCache.Category;
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static SoftFluent.Samples.RedisCache.Category LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            category = SoftFluent.Samples.RedisCache.Category.Load(var);
            return category;
        }
        ...
        public SoftFluent.Samples.RedisCache.Category Clone(bool deep)
        {
            SoftFluent.Samples.RedisCache.Category category = new SoftFluent.Samples.RedisCache.Category();
            this.CopyTo(category, deep);
            return category;
        }
        
        public SoftFluent.Samples.RedisCache.Category Clone()
        {
            SoftFluent.Samples.RedisCache.Category localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(SoftFluent.Samples.RedisCache.Category category, bool deep)
        {
            if ((category == null))
            {
                throw new System.ArgumentNullException("category");
        ...
        // CacheManager0
        public static SoftFluent.Samples.RedisCache.Category Load(System.Guid id)
        {
            return Category.CacheLoad(true, id);
        }
        
        // CacheManager0
        public static SoftFluent.Samples.RedisCache.Category NoCacheLoad(System.Guid id)
        {
            return Category.CacheLoad(false, id);
        }
        
        // CacheManager0
        public static SoftFluent.Samples.RedisCache.Category LoadById(System.Guid id)
        {
            return Category.CacheLoadById(true, id);
        }
        
        // CacheManager0
        public static SoftFluent.Samples.RedisCache.Category NoCacheLoadById(System.Guid id)
        {
        ...
        {
            SoftFluent.Samples.RedisCache.Caching.CacheManager0.Manager.Clear("SoftFluent.Samples.RedisCache.Category");
        }
    }
}
