...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0821", "CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 24 Augus" +
    "t 2015 13:32.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 1771607328u)]

namespace SoftFluent.Samples.EncryptAspect.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.EncryptAspect.SoftFluent.Samples.EncryptAspect", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.EncryptAspect.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.EncryptAspect.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.EncryptAspect.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.EncryptAspect.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.EncryptAspect.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.EncryptAspect
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_EncryptAspectStoreName = "SoftFluent.Samples.EncryptAspect";
