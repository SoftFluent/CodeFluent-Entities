...
namespace SoftFluent.Samples.EncryptAspect
{
    ...
    public partial class Customer : System.ICloneable, System.IComparable, System.IComparable<SoftFluent.Samples.EncryptAspect.Customer>, CodeFluent.Runtime.ICodeFluentCollectionEntity<System.Guid>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<SoftFluent.Samples.EncryptAspect.Customer>
    {
        ...
        public virtual bool Equals(SoftFluent.Samples.EncryptAspect.Customer customer)
        {
            if ((customer == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			customer = obj as SoftFluent.Samples.EncryptAspect.Customer;
...
customer = value as SoftFluent.Samples.EncryptAspect.Customer;
        ...
        public virtual int CompareTo(SoftFluent.Samples.EncryptAspect.Customer customer)
        {
            if ((customer == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = SoftFluent.Samples.EncryptAspect.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.EncryptAspect.Customer.ExternalValidate", "Type \'SoftFluent.Samples.EncryptAspect.Customer\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = SoftFluent.Samples.EncryptAspect.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.EncryptAspect.Customer.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "oftFluent.Samples.EncryptAspect.Customer\'", null);
        ...
        protected virtual void ReadRecord(System.Data.IDataReader reader, CodeFluent.Runtime.CodeFluentReloadOptions options)
        {
                        ...
                        == false))
            {
                ...
                this._cardNumber = CodeFluentPersistence.GetReaderValue(reader, "Customer_CardNumber", ((string)(default(string))));
            }
        ...
        public static SoftFluent.Samples.EncryptAspect.Customer Load(System.Guid id)
        {
        ...
        protected virtual bool BaseSave(bool force)
        {
            ...
            persistence.AddParameter("@Customer_CardNumber", this.CardNumber, default(string));
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static SoftFluent.Samples.EncryptAspect.Customer LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            customer = SoftFluent.Samples.EncryptAspect.Customer.Load(var);
            return customer;
        }
        ...
        public SoftFluent.Samples.EncryptAspect.Customer Clone(bool deep)
        {
            SoftFluent.Samples.EncryptAspect.Customer customer = new SoftFluent.Samples.EncryptAspect.Customer();
        ...
        public SoftFluent.Samples.EncryptAspect.Customer Clone()
        {
            SoftFluent.Samples.EncryptAspect.Customer localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(SoftFluent.Samples.EncryptAspect.Customer customer, bool deep)
        {
            if ((customer == null))
            {
                throw new System.ArgumentNullException("customer");
