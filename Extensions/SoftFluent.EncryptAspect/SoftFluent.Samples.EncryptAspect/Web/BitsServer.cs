...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 24 August 2015 13:32. Build: 1.0.61214.0821
namespace SoftFluent.Samples.EncryptAspect.Web
{
	
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0821")]
    public partial class SoftFluent_Samples_EncryptAspectBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static SoftFluent_Samples_EncryptAspectBitsServer _current;

		public SoftFluent_Samples_EncryptAspectBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Samples.EncryptAspect.Constants.SoftFluent_Samples_EncryptAspectStoreName))
		{
		}
        ...
        protected override void OnInformation(object ctx)
        {
			...
			throw new System.InvalidOperationException(SoftFluent.Samples.EncryptAspect.Resources.Manager.GetStringWithDefault("bitsServerInvalidUrl", "Invalid url '{0}'.", new object[]{context.Request.Url}));
        }
		...
		public static SoftFluent_Samples_EncryptAspectBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new SoftFluent_Samples_EncryptAspectBitsServer();
				}
				return _current;
			}
		}
