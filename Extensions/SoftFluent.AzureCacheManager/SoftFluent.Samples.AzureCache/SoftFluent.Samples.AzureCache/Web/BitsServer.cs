...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 27 August 2014 12:34. Build: 1.0.61214.0773
namespace SoftFluent.Samples.AzureCache.Web
{
	
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0773")]
    public partial class SoftFluent_Samples_AzureCacheBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static SoftFluent_Samples_AzureCacheBitsServer _current;

		public SoftFluent_Samples_AzureCacheBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Samples.AzureCache.Constants.SoftFluent_Samples_AzureCacheStoreName))
		{
		}
		
		public SoftFluent_Samples_AzureCacheBitsServer(CodeFluent.Runtime.CodeFluentContext context)
			:base(context)
		{
		}
		...
		public static SoftFluent_Samples_AzureCacheBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new SoftFluent_Samples_AzureCacheBitsServer();
				}
				return _current;
			}
		}
