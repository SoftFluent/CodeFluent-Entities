...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0773", "CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 27 Au" +
    "gust 2014 12:34.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 2901181728u)]

namespace SoftFluent.Samples.AzureCache.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.AzureCache.SoftFluent.Samples.AzureCache", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.AzureCache.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.AzureCache.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.AzureCache.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.AzureCache.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.AzureCache.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.AzureCache
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_AzureCacheStoreName = "SoftFluent.Samples.AzureCache";
...
namespace SoftFluent.Samples.AzureCache.Caching
{
    ...
    public sealed partial class CacheManager0
    {
        ...
        static SoftFluent.Samples.AzureCache.Caching.LocaleAzureCacheManager _manager;
        
        static CacheManager0()
        {
            CacheManager0._manager = new SoftFluent.Samples.AzureCache.Caching.LocaleAzureCacheManager();
        }
    ...
    public sealed partial class CacheManager1
    {
        ...
        static SoftFluent.Samples.AzureCache.Caching.AzureCacheManager _manager;
        
        static CacheManager1()
        {
            CacheManager1._manager = new SoftFluent.Samples.AzureCache.Caching.AzureCacheManager();
        }
