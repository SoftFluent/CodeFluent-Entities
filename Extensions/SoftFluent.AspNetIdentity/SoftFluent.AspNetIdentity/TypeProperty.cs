...
namespace SoftFluent.AspNetIdentity
{
    public class TypeProperty
    {
        ...
        public static readonly IEnumerable<TypeProperty> UserProperties = new List<TypeProperty>()
        {
            ...
            new TypeProperty("AccessFailedCount", PropertyType.UserFailedPasswordAttemptCount, "int", mandatory: false, nullable:false),
            new TypeProperty("AccessFailedWindowStart", PropertyType.UserFailedPasswordAttemptWindowStart, "datetime", mandatory: false, nullable:true),
