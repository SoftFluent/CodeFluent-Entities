...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 23 February 2015 11:33. Build: 1.0.61214.0803
namespace SoftFluent.Json.NET.Web
{
	
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0803")]
    public partial class SoftFluent_Json_NETBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static SoftFluent_Json_NETBitsServer _current;

		public SoftFluent_Json_NETBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Json.NET.Constants.SoftFluent_Json_NETStoreName))
		{
		}
        ...
        protected override void OnInformation(object ctx)
        {
			...
			throw new System.InvalidOperationException(SoftFluent.Json.NET.Resources.Manager.GetStringWithDefault("bitsServerInvalidUrl", "Invalid url '{0}'.", new object[]{context.Request.Url}));
        }
		...
		public static SoftFluent_Json_NETBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new SoftFluent_Json_NETBitsServer();
				}
				return _current;
			}
		}
