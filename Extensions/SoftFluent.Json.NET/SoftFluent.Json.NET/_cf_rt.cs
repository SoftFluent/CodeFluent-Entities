...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0803", "CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 23 Febru" +
    "ary 2015 11:33.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 4079969542u)]

namespace SoftFluent.Json.NET.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Json.NET.SoftFluent.Json.NET", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Json.NET.Resources.ValueValidationFailureHandler _current = new SoftFluent.Json.NET.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Json.NET.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Json.NET.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Json.NET.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Json.NET
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Json_NETStoreName = "SoftFluent.Json.NET";
