...
namespace SoftFluent.SqlServerInMemory
{
    ...
    public partial class Customer : System.ICloneable, System.IComparable, System.IComparable<SoftFluent.SqlServerInMemory.Customer>, CodeFluent.Runtime.ICodeFluentCollectionEntity<System.Guid>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<SoftFluent.SqlServerInMemory.Customer>
    {
        ...
        private SoftFluent.SqlServerInMemory.ContactSource _contactSource = null;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public SoftFluent.SqlServerInMemory.ContactSource ContactSource
        {
            get
            {
                if ((this._contactSource == null))
                {
                    this._contactSource = SoftFluent.SqlServerInMemory.ContactSource.Load(this._contactSourceId);
                }
        ...
        public virtual bool Equals(SoftFluent.SqlServerInMemory.Customer customer)
        {
            if ((customer == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			customer = obj as SoftFluent.SqlServerInMemory.Customer;
...
customer = value as SoftFluent.SqlServerInMemory.Customer;
        ...
        public virtual int CompareTo(SoftFluent.SqlServerInMemory.Customer customer)
        {
            if ((customer == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = SoftFluent.SqlServerInMemory.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.SqlServerInMemory.Customer.ExternalValidate", "Type \'SoftFluent.SqlServerInMemory.Customer\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = SoftFluent.SqlServerInMemory.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.SqlServerInMemory.Customer.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "oftFluent.SqlServerInMemory.Customer\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.Name == default(string)))
            {
                string localValidate1 = SoftFluent.SqlServerInMemory.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.SqlServerInMemory.Customer.Name.NullException", "\'Name\' property cannot be set to \'\' for type \'SoftFluent.SqlServerInMemory.Custom" +
                        "er\'", null);
        ...
        public static SoftFluent.SqlServerInMemory.Customer Load(System.Guid id)
        {
        ...
        public SoftFluent.SqlServerInMemory.Customer Clone(bool deep)
        {
            SoftFluent.SqlServerInMemory.Customer customer = new SoftFluent.SqlServerInMemory.Customer();
        ...
        public SoftFluent.SqlServerInMemory.Customer Clone()
        {
            SoftFluent.SqlServerInMemory.Customer localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(SoftFluent.SqlServerInMemory.Customer customer, bool deep)
        {
            if ((customer == null))
            {
                throw new System.ArgumentNullException("customer");
            ...
            customer.ContactSourceId = this.ContactSourceId;
