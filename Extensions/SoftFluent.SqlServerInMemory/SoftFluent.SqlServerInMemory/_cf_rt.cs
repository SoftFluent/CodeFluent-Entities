...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0772", "CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 09 Ju" +
    "ly 2014 12:19.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 1696664373u)]

namespace SoftFluent.SqlServerInMemory.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.SqlServerInMemory.SoftFluent.SqlServerInMemory", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.SqlServerInMemory.Resources.ValueValidationFailureHandler _current = new SoftFluent.SqlServerInMemory.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.SqlServerInMemory.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.SqlServerInMemory.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.SqlServerInMemory.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.SqlServerInMemory
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_SqlServerInMemoryStoreName = "SoftFluent.SqlServerInMemory";
