...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0769", "CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 30 Ap" +
    "ril 2014 11:48.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 2973857785u)]

namespace SoftFluent.Samples.AspNetIdentity2.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.AspNetIdentity2.SoftFluent.Samples.AspNetIdentity2", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.AspNetIdentity2.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.AspNetIdentity2.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.AspNetIdentity2.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.AspNetIdentity2.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.AspNetIdentity2.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.AspNetIdentity2
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_AspNetIdentity2StoreName = "SoftFluent.Samples.AspNetIdentity2";
