...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 30 April 2014 11:48. Build: 1.0.61214.0769
namespace SoftFluent.Samples.AspNetIdentity2.Web
{
    ...
    public partial class SoftFluent_Samples_AspNetIdentity2BitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static SoftFluent_Samples_AspNetIdentity2BitsServer _current;

		public SoftFluent_Samples_AspNetIdentity2BitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Samples.AspNetIdentity2.Constants.SoftFluent_Samples_AspNetIdentity2StoreName))
		{
		}
		
		public SoftFluent_Samples_AspNetIdentity2BitsServer(CodeFluent.Runtime.CodeFluentContext context)
			:base(context)
		{
		}
        ...
        protected override void OnInformation(object ctx)
        {
			...
			throw new System.InvalidOperationException(SoftFluent.Samples.AspNetIdentity2.Resources.Manager.GetStringWithDefault("bitsServerInvalidUrl", "Invalid url '{0}'.", new object[]{context.Request.Url}));
        }
		...
		public static SoftFluent_Samples_AspNetIdentity2BitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new SoftFluent_Samples_AspNetIdentity2BitsServer();
				}
				return _current;
			}
		}
