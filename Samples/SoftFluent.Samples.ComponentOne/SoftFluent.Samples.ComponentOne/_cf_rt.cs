...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0786", "CodeFluent Entities generated (http://www.softfluent.com). Date: Monday, 06 Octob" +
    "er 2014 17:27.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 97571244u)]

namespace SoftFluent.Samples.ComponentOne.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.ComponentOne.SoftFluent.Samples.ComponentOne", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.ComponentOne.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.ComponentOne.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.ComponentOne.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.ComponentOne.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.ComponentOne.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.ComponentOne
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_ComponentOneStoreName = "SoftFluent.Samples.ComponentOne";
