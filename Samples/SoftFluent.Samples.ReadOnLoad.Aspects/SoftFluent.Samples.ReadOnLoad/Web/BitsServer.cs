...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 18 June 2014 17:47. Build: 1.0.61214.0770
namespace SoftFluent.Samples.ReadOnLoad.Web
{
    ...
    public partial class Samples_ReadOnLoadBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static Samples_ReadOnLoadBitsServer _current;

		public Samples_ReadOnLoadBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Samples.ReadOnLoad.Constants.Samples_ReadOnLoadStoreName))
		{
		}
		
		public Samples_ReadOnLoadBitsServer(CodeFluent.Runtime.CodeFluentContext context)
			:base(context)
		{
		}
		...
		public static Samples_ReadOnLoadBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new Samples_ReadOnLoadBitsServer();
				}
				return _current;
			}
		}
