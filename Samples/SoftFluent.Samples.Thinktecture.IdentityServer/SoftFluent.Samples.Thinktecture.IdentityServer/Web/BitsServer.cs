...
namespace SoftFluent.Samples.Thinktecture.IdentityServer.Web
{
	
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.61214.0769")]
    public partial class SoftFluent_Samples_Thinktecture_IdentityServerBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		private static SoftFluent_Samples_Thinktecture_IdentityServerBitsServer _current;

		public SoftFluent_Samples_Thinktecture_IdentityServerBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(SoftFluent.Samples.Thinktecture.IdentityServer.Constants.SoftFluent_Samples_Thinktecture_IdentityServerStoreName))
		{
		}
        ...
        protected override void OnInformation(object ctx)
        {
			...
			throw new System.InvalidOperationException(SoftFluent.Samples.Thinktecture.IdentityServer.Resources.Manager.GetStringWithDefault("bitsServerInvalidUrl", "Invalid url '{0}'.", new object[]{context.Request.Url}));
        }
		...
		public static SoftFluent_Samples_Thinktecture_IdentityServerBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new SoftFluent_Samples_Thinktecture_IdentityServerBitsServer();
				}
				return _current;
			}
		}
