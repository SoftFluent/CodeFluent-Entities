...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0769", "CodeFluent Entities generated (http://www.softfluent.com). Date: Tuesday, 27 May " +
    "2014 10:59.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 2727522101u)]

namespace SoftFluent.Samples.Thinktecture.IdentityServer.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.Thinktecture.IdentityServer.SoftFluent.Samples.Thinktecture.Id" +
                    "entityServer", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.Thinktecture.IdentityServer.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.Thinktecture.IdentityServer.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.Thinktecture.IdentityServer.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.Thinktecture.IdentityServer.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.Thinktecture.IdentityServer.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.Thinktecture.IdentityServer
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_Thinktecture_IdentityServerStoreName = "SoftFluent.Samples.Thinktecture.IdentityServer";
