...
namespace SoftFluent.Samples.GED.Security
{
    ...
    public partial class Role : System.ICloneable, System.IComparable, System.IComparable<SoftFluent.Samples.GED.Security.Role>, CodeFluent.Runtime.ICodeFluentCollectionEntity<string>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<SoftFluent.Samples.GED.Security.Role>
    {
        ...
        private SoftFluent.Samples.GED.Security.UserRoleCollection _users;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public SoftFluent.Samples.GED.Security.UserRoleCollection Users
        {
            get
            {
                if ((this._users == null))
                {
                    ...
                    {
                        this._users = new SoftFluent.Samples.GED.Security.UserRoleCollection(this, null);
                        return this._users;
                    }
                    this._users = SoftFluent.Samples.GED.Security.UserRoleCollection.LoadByRole(this);
                }
                return this._users;
            }
        }
        ...
        public virtual bool Equals(SoftFluent.Samples.GED.Security.Role role)
        {
            if ((role == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			role = obj as SoftFluent.Samples.GED.Security.Role;
...
role = value as SoftFluent.Samples.GED.Security.Role;
        ...
        public virtual int CompareTo(SoftFluent.Samples.GED.Security.Role role)
        {
            if ((role == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = SoftFluent.Samples.GED.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.GED.Security.Role.ExternalValidate", "Type \'SoftFluent.Samples.GED.Security.Role\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = SoftFluent.Samples.GED.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.GED.Security.Role.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "oftFluent.Samples.GED.Security.Role\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.Name == default(string)))
            {
                string localValidate1 = SoftFluent.Samples.GED.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.GED.Security.Role.Name.NullException", "\'Name\' property cannot be set to \'\' for type \'SoftFluent.Samples.GED.Security.Rol" +
                        "e\'", null);
        ...
        public static SoftFluent.Samples.GED.Security.Role Load(System.Guid id)
        {
        ...
        public static SoftFluent.Samples.GED.Security.Role LoadByName(string name)
        {
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static SoftFluent.Samples.GED.Security.Role LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            role = SoftFluent.Samples.GED.Security.Role.Load(var);
            return role;
        }
        ...
        public SoftFluent.Samples.GED.Security.Role Clone(bool deep)
        {
            SoftFluent.Samples.GED.Security.Role role = new SoftFluent.Samples.GED.Security.Role();
        ...
        public SoftFluent.Samples.GED.Security.Role Clone()
        {
            SoftFluent.Samples.GED.Security.Role localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(SoftFluent.Samples.GED.Security.Role role, bool deep)
        {
            if ((role == null))
            {
                throw new System.ArgumentNullException("role");
