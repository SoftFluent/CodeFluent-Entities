...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0769", "CodeFluent Entities generated (http://www.softfluent.com). Date: Thursday, 08 May" +
    " 2014 20:42.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 3415957938u)]

namespace SoftFluent.Samples.GED.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.GED.SoftFluent.Samples.GED", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.GED.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.GED.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.GED.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.GED.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.GED.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.GED
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_GEDStoreName = "SoftFluent.Samples.GED";
