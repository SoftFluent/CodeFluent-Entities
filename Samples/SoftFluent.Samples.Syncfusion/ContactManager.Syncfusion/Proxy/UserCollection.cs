...
namespace ContactManager.Proxy
{
    ...
    public partial class UserCollection : CodeFluent.Runtime.ServiceModel.CodeFluentEntityCollection<string, ContactManager.Proxy.User>, CodeFluent.Runtime.ServiceModel.ICodeFluentSet, CodeFluent.Runtime.Diagnostics.ITraceable
    {
        ...
        {
            ContactManager.Proxy.UserCollection collection = new ContactManager.Proxy.UserCollection(ContactManager.Proxy.Constants.ContactManagerStoreName, ((System.ServiceModel.Channels.IChannel)(ContactManager.Proxy.User.WcfClient.Current.Channel)), "PageLoadAll", null);
        ...
        {
            ContactManager.Proxy.UserCollection collection = new ContactManager.Proxy.UserCollection(ContactManager.Proxy.Constants.ContactManagerStoreName, ((System.ServiceModel.Channels.IChannel)(ContactManager.Proxy.User.WcfClient.Current.Channel)), "PageSearch", null, id, email, firstName, lastName);
            collection.LoadKnownItems();
            return collection;
        }
