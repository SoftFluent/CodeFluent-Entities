    ...
    if ((this.PropertyChanged != null))
    {
        ...
        public virtual void ValidateLocal(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = MyCie.ContactManager.Proxy.Resources.Manager.GetStringWithDefault(culture, "ContactManager.Proxy.ContactSource.ExternalValidate", "Type \'ContactManager.ContactSource\' cannot be validated.", null);
                }
