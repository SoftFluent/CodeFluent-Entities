<%@ Page Title="default Form" Language="C#" MasterPageFile="~/Dialog.master" AutoEventWireup="true" CodeBehind="UserLoadDefaultForm.aspx.cs" Inherits="ContactManager.Web.UserLoadDefaultForm" %>
		...
		<cfe:FreeFormView runat="server" ID="FreeForm" AutoBind="true" DecamelizeOptions="None">
			<ItemTemplate>
				<table width="100%" class="fields">				
					<tr><td>Id</td><td><cfe:NumericTextBox runat="server" ID="i35" Value='<%#Bind("Id")%>' TargetTypeName="System.Int32" Format="" /></td></tr>				
					</table>
