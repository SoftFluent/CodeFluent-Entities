<%@ Page Title="default Form" Language="C#" MasterPageFile="~/Dialog.master" AutoEventWireup="true" CodeBehind="AddressLoadDefaultForm.aspx.cs" Inherits="ContactManager.Web.AddressLoadDefaultForm" %>
		...
		<cfe:FreeFormView runat="server" ID="FreeForm" AutoBind="true" DecamelizeOptions="None">
			<ItemTemplate>
				<table width="100%" class="fields">				
					<tr><td>Id</td><td><cfe:NumericTextBox runat="server" ID="i26" Value='<%#Bind("Id")%>' TargetTypeName="System.Int32" Format="" /></td></tr>				
					</table>
