<%@ Page Title="default Form" Language="C#" MasterPageFile="~/Dialog.master" AutoEventWireup="true" CodeBehind="UserLoadByEmailDefaultForm.aspx.cs" Inherits="ContactManager.Web.UserLoadByEmailDefaultForm" %>
		...
		<cfe:FreeFormView runat="server" ID="FreeForm" AutoBind="true" DecamelizeOptions="None">
			<ItemTemplate>
				<table width="100%" class="fields">				
					<tr><td>Email</td><td><asp:TextBox runat="server" ID="i36" Text='<%#Bind("Email")%>' MaxLength="256" /></td></tr>				
					</table>
