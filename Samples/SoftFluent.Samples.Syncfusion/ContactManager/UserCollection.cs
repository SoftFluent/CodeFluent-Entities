...
namespace ContactManager
{
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(ContactManager.User))]
    [System.Runtime.Serialization.CollectionDataContractAttribute(Namespace="http://schemas.contactmanager.com", ItemName="User")]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(ContactManager.User))]
    public partial class UserCollection : System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList<ContactManager.User>, System.Collections.Generic.ICollection<ContactManager.User>, System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
    {
        ...
        private System.Collections.Generic.List<ContactManager.User> _baseList = new System.Collections.Generic.List<ContactManager.User>();
        
        [System.NonSerializedAttribute()]
        private System.Collections.Generic.Dictionary<string, ContactManager.User> _baseTable = new System.Collections.Generic.Dictionary<string, ContactManager.User>();
        ...
        [System.NonSerializedAttribute()]
        private CodeFluent.Runtime.Utilities.BindingListManager<ContactManager.User> _blm2421662433;
        ...
        {
            this._blm2421662433 = new CodeFluent.Runtime.Utilities.BindingListManager<ContactManager.User>(this);
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        protected System.Collections.Generic.List<ContactManager.User> BaseList
        {
            get
            {
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        protected System.Collections.Generic.Dictionary<string, ContactManager.User> BaseTable
        {
            get
            {
        ...
        public ContactManager.User this[int index]
        {
            get
            {
                return ((ContactManager.User)(this.BaseList[index]));
            }
            set
            {
        ...
        object System.Collections.IList.this[int index]
        {
            ...
            set
            {
                this.BaseList[index] = ((ContactManager.User)(value));
            }
        }
        
        public ContactManager.User this[string email]
        {
            get
            {
                ...
                ContactManager.User i = this.TryGetValue(email);
                return i;
            }
            set
            {
                ...
                if ((value == null))
                {
                    ContactManager.User user = this.TryGetValue(email);
                    if ((user != null))
                    {
                        this.Remove(user);
                    }
                ...
                ContactManager.User existing = this.TryGetValue(value.Email);
                if ((existing != null))
                {
        ...
        bool System.ComponentModel.IBindingList.AllowEdit
        {
            get
            {
                return this._blm2421662433.AllowEdit;
            }
        }
        ...
        bool System.ComponentModel.IBindingList.AllowNew
        {
            get
            {
                return this._blm2421662433.AllowNew;
            }
        }
        ...
        bool System.ComponentModel.IBindingList.AllowRemove
        {
            get
            {
                return this._blm2421662433.AllowRemove;
            }
        }
        ...
        bool System.ComponentModel.IBindingList.IsSorted
        {
            get
            {
                return this._blm2421662433.IsSorted;
            }
        }
        ...
        System.ComponentModel.ListSortDirection System.ComponentModel.IBindingList.SortDirection
        {
            get
            {
                return this._blm2421662433.SortDirection;
            }
        }
        ...
        System.ComponentModel.PropertyDescriptor System.ComponentModel.IBindingList.SortProperty
        {
            get
            {
                return this._blm2421662433.SortProperty;
            }
        }
        ...
        bool System.ComponentModel.IBindingList.SupportsSearching
        {
            get
            {
                return this._blm2421662433.SupportsSearching;
            }
        }
        ...
        bool System.ComponentModel.IBindingList.SupportsSorting
        {
            get
            {
                return this._blm2421662433.SupportsSorting;
            }
        }
        ...
        protected virtual void Relate(ContactManager.User item, CodeFluent.Runtime.CodeFluentRelationType relationType)
        {
            ((CodeFluent.Runtime.ICodeFluentSet)(this)).Relations[item] = relationType;
        }
        
        public int Add(ContactManager.User user)
        {
        ...
        protected virtual int BaseAdd(ContactManager.User user)
        {
            if ((user == null))
            {
            ...
            {
                throw new System.ArgumentNullException(ContactManager.Resources.Manager.GetUserMessage(null, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "ContactManager.UserCollection", user.EntityKey), ane);
            }
            catch (System.ArgumentException ae)
            {
                throw new System.ArgumentException(ContactManager.Resources.Manager.GetUserMessage(null, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "ContactManager.UserCollection", user.Email), ae);
            }
        ...
        int System.Collections.IList.Add(object value)
        {
            ...
            try
            {
                user = ((ContactManager.User)(value));
            }
        ...
        void System.Collections.Generic.ICollection<ContactManager.User>.Add(ContactManager.User user)
        {
            this.BaseAdd(user);
        }
        
        public virtual ContactManager.User AddByEntityKey(string key)
        {
            ContactManager.User user = ContactManager.User.LoadByEntityKey(key);
            if (((user != null) 
        ...
        public virtual void Sort(System.Collections.Generic.IComparer<ContactManager.User> comparer)
        {
            this.BaseList.Sort(comparer);
        }
        
        public void CopyTo(ContactManager.User[] array, int index)
        {
            this.BaseCopyTo(array, index);
        }
        
        protected virtual void BaseCopyTo(ContactManager.User[] array, int index)
        {
        ...
        public bool Contains(ContactManager.User user)
        {
            bool localContains = this.BaseContains(user);
            return localContains;
        }
        
        protected virtual bool BaseContains(ContactManager.User user)
        {
            if ((user == null))
            {
                return false;
        ...
        public int IndexOf(ContactManager.User user)
        {
            int localIndexOf = this.BaseIndexOf(user);
            return localIndexOf;
        }
        
        protected virtual int BaseIndexOf(ContactManager.User user)
        {
            if ((user == null))
            {
                return -1;
        ...
        public void Insert(int index, ContactManager.User user)
        {
            this.BaseInsert(index, user);
        }
        
        protected virtual void BaseInsert(int index, ContactManager.User user)
        {
            if ((user == null))
            {
                throw new System.ArgumentNullException("user");
        ...
        public virtual void Clear()
        {
            ...
            {
                ContactManager.User User = this[0];
        ...
        public bool Remove(ContactManager.User user)
        {
            return this.BaseRemove(user);
        }
        
        protected virtual bool BaseRemove(ContactManager.User user)
        {
            if ((user == null))
            {
                throw new System.ArgumentNullException("user");
            ...
            this.OnListChanged(new System.ComponentModel.ListChangedEventArgs(((System.ComponentModel.ListChangedType)(CodeFluent.Runtime.Utilities.SortableBindingList<ContactManager.User>.ListChangedTypeDeleting)), index));
            bool ret;
        ...
        {
            this.OnListChanged(new System.ComponentModel.ListChangedEventArgs(((System.ComponentModel.ListChangedType)(CodeFluent.Runtime.Utilities.SortableBindingList<ContactManager.User>.ListChangedTypeDeleting)), index));
            ContactManager.User user = this.BaseList[index];
            if ((user != null))
            {
                user.KeyChanged -= new System.EventHandler<CodeFluent.Runtime.Utilities.KeyChangedEventArgs<string>>(this.OnItemKeyChanged);
        ...
        public virtual System.Collections.Generic.IEnumerator<ContactManager.User> GetEnumerator()
        {
            System.Collections.Generic.IEnumerator<ContactManager.User> e = this.BaseList.GetEnumerator();
            return e;
        }
        ...
        private ContactManager.User TryGetValue(string key)
        {
            ContactManager.User user;
        ...
        public virtual void SaveAll()
        {
            ...
            {
                ContactManager.User user = this[index];
                user.Save();
        ...
        public static ContactManager.UserCollection PageLoadAll(int pageIndex, int pageSize, CodeFluent.Runtime.PageOptions pageOptions)
        {
            if ((pageIndex < 0))
            {
                pageIndex = 0;
            ...
            try
            {
                reader = ContactManager.UserCollection.PageDataLoadAll(pageOptions);
                if ((reader == null))
                {
                    return ret;
                }
        ...
        {
            System.Data.IDataReader reader = ContactManager.UserCollection.PageDataLoadAll(null);
            return reader;
        }
        ...
        public static System.Data.IDataReader DataSearch(int id, string email, string firstName, string lastName)
        {
            System.Data.IDataReader reader = ContactManager.UserCollection.PageDataSearch(null, id, email, firstName, lastName);
            return reader;
        }
        ...
        {
            this._blm2421662433.AddIndex(property);
        }
        ...
        public void AddRange(System.Collections.Generic.IEnumerable<ContactManager.User> collection)
        {
        ...
        private void OnItemKeyChanged(object sender, CodeFluent.Runtime.Utilities.KeyChangedEventArgs<string> e)
        {
                        ...
                        && (typeof(CodeFluent.Runtime.Utilities.IKeyable<string>).IsAssignableFrom(sender.GetType()) == true)))
            {
                ...
                {
                    throw new System.ArgumentNullException(ContactManager.Resources.Manager.GetUserMessage(null, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "ContactManager.UserCollection", ((CodeFluent.Runtime.ICodeFluentEntity)(item)).EntityKey), ane);
                }
                catch (System.ArgumentException ae)
                {
                    throw new System.ArgumentException(ContactManager.Resources.Manager.GetUserMessage(null, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "ContactManager.UserCollection", item.Key), ae);
                }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static ContactManager.UserCollection PageLoadAll(int pageIndex, int pageSize)
        {
            return ContactManager.UserCollection.PageLoadAll(pageIndex, pageSize, null);
        }
        
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static ContactManager.UserCollection PageSearch(int pageIndex, int pageSize, int id, string email, string firstName, string lastName)
        {
            return ContactManager.UserCollection.PageSearch(pageIndex, pageSize, null, id, email, firstName, lastName);
        }
