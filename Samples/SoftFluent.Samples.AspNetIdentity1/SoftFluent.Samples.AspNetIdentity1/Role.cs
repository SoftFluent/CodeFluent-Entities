...
namespace SoftFluent.Samples.AspNetIdentity1
{
    ...
    public partial class Role : Microsoft.AspNet.Identity.IRole, System.ICloneable, System.IComparable, System.IComparable<SoftFluent.Samples.AspNetIdentity1.Role>, CodeFluent.Runtime.ICodeFluentCollectionEntity<string>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<SoftFluent.Samples.AspNetIdentity1.Role>
    {
        ...
        private SoftFluent.Samples.AspNetIdentity1.UserCollection _users;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public SoftFluent.Samples.AspNetIdentity1.UserCollection Users
        {
            get
            {
                if ((this._users == null))
                {
                    ...
                    {
                        this._users = new SoftFluent.Samples.AspNetIdentity1.UserCollection(this);
                        return this._users;
                    }
                    this._users = SoftFluent.Samples.AspNetIdentity1.UserCollection.LoadUsersRolesByRole(this);
                }
                return this._users;
            }
        }
        ...
        public virtual bool Equals(SoftFluent.Samples.AspNetIdentity1.Role role)
        {
            if ((role == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			role = obj as SoftFluent.Samples.AspNetIdentity1.Role;
        ...
        internal void SaveUsersRelations()
        {
            ...
            for (b = enumerator.MoveNext(); b; b = enumerator.MoveNext())
            {
                ...
                SoftFluent.Samples.AspNetIdentity1.User user = ((SoftFluent.Samples.AspNetIdentity1.User)(entry.Key));
                            ...
                            == false)))
                {
                    ...
                    persistence.AddParameter("@Role_Id", this.Id, default(string));
                    persistence.AddParameter("@User_Id", user.Id, default(string));
                ...
                else
                {
                    ...
                    persistence1.AddParameter("@Role_Id", this.Id, default(string));
                    persistence1.AddParameter("@User_Id", user.Id, default(string));
...
role = value as SoftFluent.Samples.AspNetIdentity1.Role;
        ...
        public virtual int CompareTo(SoftFluent.Samples.AspNetIdentity1.Role role)
        {
            if ((role == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = SoftFluent.Samples.AspNetIdentity1.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.AspNetIdentity1.Role.ExternalValidate", "Type \'SoftFluent.Samples.AspNetIdentity1.Role\' cannot be validated.", null);
                }
            ...
            if ((this.Id == default(string)))
            {
                string localValidate = SoftFluent.Samples.AspNetIdentity1.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.AspNetIdentity1.Role.Id.NullException", "\'Id\' property cannot be set to \'\' for type \'SoftFluent.Samples.AspNetIdentity1.Ro" +
                        "le\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.Name == default(string)))
            {
                string localValidate1 = SoftFluent.Samples.AspNetIdentity1.Resources.Manager.GetStringWithDefault(culture, "SoftFluent.Samples.AspNetIdentity1.Role.Name.NullException", "\'Name\' property cannot be set to \'\' for type \'SoftFluent.Samples.AspNetIdentity1." +
                        "Role\'", null);
        ...
        protected virtual void ReadRecord(System.Data.IDataReader reader, CodeFluent.Runtime.CodeFluentReloadOptions options)
        {
            ...
            if ((((options & CodeFluent.Runtime.CodeFluentReloadOptions.Properties) 
                        ...
                        == false))
            {
                this._id = CodeFluentPersistence.GetReaderValue(reader, "Role_Id", ((string)(default(string))));
        ...
        public static SoftFluent.Samples.AspNetIdentity1.Role Load(string id)
        {
        ...
        public static SoftFluent.Samples.AspNetIdentity1.Role LoadByName(string name)
        {
...
dictionary = values as System.Collections.IDictionary;
            ...
            SoftFluent.Samples.AspNetIdentity1.UserCollection users = null;
users = values as SoftFluent.Samples.AspNetIdentity1.UserCollection;
            if ((users != null))
            {
                this._users = users;
                return;
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static SoftFluent.Samples.AspNetIdentity1.Role LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            role = SoftFluent.Samples.AspNetIdentity1.Role.Load(key);
            return role;
        }
        ...
        public SoftFluent.Samples.AspNetIdentity1.Role Clone(bool deep)
        {
            SoftFluent.Samples.AspNetIdentity1.Role role = new SoftFluent.Samples.AspNetIdentity1.Role();
        ...
        public SoftFluent.Samples.AspNetIdentity1.Role Clone()
        {
            SoftFluent.Samples.AspNetIdentity1.Role localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(SoftFluent.Samples.AspNetIdentity1.Role role, bool deep)
        {
            if ((role == null))
            {
                throw new System.ArgumentNullException("role");
