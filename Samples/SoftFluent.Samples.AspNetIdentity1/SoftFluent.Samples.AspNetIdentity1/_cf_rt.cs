...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0769", "CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 30 Ap" +
    "ril 2014 16:17.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 1717076838u)]

namespace SoftFluent.Samples.AspNetIdentity1.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("SoftFluent.Samples.AspNetIdentity1.SoftFluent.Samples.AspNetIdentity1", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static SoftFluent.Samples.AspNetIdentity1.Resources.ValueValidationFailureHandler _current = new SoftFluent.Samples.AspNetIdentity1.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static SoftFluent.Samples.AspNetIdentity1.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return SoftFluent.Samples.AspNetIdentity1.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = SoftFluent.Samples.AspNetIdentity1.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace SoftFluent.Samples.AspNetIdentity1
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string SoftFluent_Samples_AspNetIdentity1StoreName = "SoftFluent.Samples.AspNetIdentity1";
